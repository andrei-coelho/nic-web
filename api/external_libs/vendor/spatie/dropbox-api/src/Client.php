...
class Client
{
    ...
    public function uploadMultipleFiles(string $path, array $contents, $mode = 'add', $autorename = false): array{
    ...
    public function uploadSessionFinishBatch($contents, array $cursors, string $path, $mode = 'add', $autorename = false, $mute = false): array{
